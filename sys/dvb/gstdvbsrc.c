...
static gboolean gst_dvbsrc_output_frontend_stats2 (GstDvbSrc * src,
    fe_status_t * status);
...
static gboolean
gst_dvbsrc_output_frontend_stats2 (GstDvbSrc * src, fe_status_t * status)
{
  guint16 snr, signal;
...
gst_dvbsrc_tune_fe (GstDvbSrc * object)
{
  ...
  do {
    ...
    if (!gst_dvbsrc_output_frontend_stats2 (object, &status))
